...
export const RETENTION_REGISTRY: readonly RetentionRow[] = [
	...
	// ─────────────────────────────────────────────────────────────────────────
	{
		...
		writerCitations: [
			'src/background/pending-delegations.ts:2173 appendRecord — appendFileSync :2178 (16 mutation entry points :2325-3961)',
			'src/background/pending-delegations.ts:923 writeDurableFileSync — fsync+rename-with-retry for checkpoint/manifest/rolled-tail (:1978-2019)',
		],
		readerCitations: [
			'src/background/pending-delegations.ts:2116 readDelegations — checkpoint+tail fold (lenient), sync',
			'src/background/pending-delegations.ts:2137 scanDelegationsForRecovery — strict, fails closed',
		...
		schemaVersion: 'RecordSchema schemaVersion 1|2|3; checkpoint/manifest literal 1 (:817,:838,:848)',
		stateClass: 'authoritative',
		privacyClass: 'metadata',
		writeLimits: {
		...
		readBound: {
			...
			sync: true,
			citation: 'src/background/pending-delegations.ts:77-82,1346',
		},
		lockModel: 'withEvidenceLock agent=background on every mutation (:129-132); reads lock-free',
		crashBehavior: 'torn append tolerated by lenient fold, strict recovery fails closed; manifest-gated checkpoint publication — checkpoint without manifest ignored (:1087-1099)',
		...
		legacyCompatibility: 'loadLegacyLedger pre-checkpoint fold (:1346); mixed-version lines safeParse individually',

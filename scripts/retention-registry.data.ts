...
export const RETENTION_REGISTRY: readonly RetentionRow[] = [
	...
	// ─────────────────────────────────────────────────────────────────────────
	{
		...
		readerCitations: [
			'src/background/pending-delegations.ts:2407 readDelegations — checkpoint+tail fold (lenient), sync',
			'src/background/pending-delegations.ts:2428 scanDelegationsForRecovery — strict, fails closed',
		...
		legacyCompatibility:
			'loadLegacyLedger pre-checkpoint fold (:1557); mixed-version lines safeParse individually',
	...
	},
	{
		...
		writerCitations: [
			'src/background/pending-delegations.ts:4610 writeDelegationFallback / :4661 removeDelegationFallback',
			'src/background/pending-delegations.ts:4891 writeBackgroundCoderReservations',
		],
		readerCitations: [
			'src/background/pending-delegations.ts:4465 readDelegationFallback / :4477 listDelegationFallbacks / :4512 scanDelegationFallbacksForRecovery',
			'src/background/pending-delegations.ts:4835 scanBackgroundCoderReservationsForAdmission',
		],

...
async function callToolBefore(
	...
	// reaching the recovery/corruption logic under test here. The mega_coder
	// Task dispatches in this file carry no prompt text field at all, so add
	// an inert ACCEPTANCE-only prompt (no N.M-shaped tokens, no other KEY:
	// headers).

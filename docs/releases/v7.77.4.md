...
- **Timestamp freshness** (src/tools/phase-complete/gates/final-council-gate.ts): Added 24h staleness warning and future-timestamp blocking check, mirroring ^Grchitecture-supervisor-gate.ts pattern.

...
export const RETENTION_REGISTRY: readonly RetentionRow[] = [
	...
	},
	{
		...
		writerCitations: ['src/test-impact/analyzer.ts:681 saveImpactMap — plain writeFileSync :711 (non-atomic; rebuildable cache)'],
		readerCitations: ['src/test-impact/analyzer.ts:666 loadImpactMap — map-only API; authoritative identity validation/rebuild, with unverified skipRebuild envelope reads'],

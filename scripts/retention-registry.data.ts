...
export const RETENTION_REGISTRY: readonly RetentionRow[] = [
	...
	},
	{
		...
		writerCitations: ['src/evidence/phase-participation.ts:482 writeStore — byte-limit trim evicting oldest pending/receipts; quarantine on corruption :376-446'],
		readerCitations: ['src/evidence/phase-participation.ts:813 readPhaseParticipation — bounded raw read (:215, ≤256 KiB, symlink guards), sync'],

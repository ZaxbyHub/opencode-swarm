...
export const RETENTION_REGISTRY: readonly RetentionRow[] = [
...

	{
		...
		writerCitations: ['src/tools/sast-baseline.ts:480 captureOrMergeBaseline — temp+rename :750-755,808-813; full prune of rescanned fingerprints :566-582'],
		readerCitations: ['src/tools/sast-baseline.ts:841 loadBaseline — full-file readFileSync :861, typed result, sync'],
		schemaVersion:
		...
		healthSignal: 'n/a',
		owner: 'this-gate',
		disposition: { kind: 'not-a-defect', proof: 'Hard caps 2000 findings / 2 MiB with write-side truncation (src/tools/sast-baseline.ts:72-75,689-711).' },
	},

...
export const RETENTION_REGISTRY: readonly RetentionRow[] = [
	...
	},
	{
		...
		readBound: { pattern: 'line-bounded', bound: 'flush reads at most MAX_SPOOL_LINES_PER_FLUSH lines + health stat', sync: true, citation: 'src/observability/otlp-exporter.ts:575-578' },
		...
		owner: '#2485',
		disposition: { kind: 'retain-by-design', citation: 'Opt-in bounded export spool: byte+age budgets with drop-oldest terminal reasons (src/observability/otlp-exporter.ts:358-394), privacy-filtered BEFORE append (no raw payload ever spooled, :756-761), restart replay by design (#2485).' },
	},
	{

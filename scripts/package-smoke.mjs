	...
	try {
		...
		writeFileSync(
			...
			[
				...
				"const evaluationTasks = loadTier1EvaluationTasks(packageRoot);",
		...
		writeFileSync(
			...
			[
				...
				"const task = { ...taskDraft, contentHash: evaluationV1.hashTaskInput(root, taskDraft) };",
				"const baseline = { ...baselineDraft, contentHash: evaluationV1.hashCandidateInput(root, baselineDraft) };",
				"const candidate = { ...candidateDraft, contentHash: evaluationV1.hashCandidateInput(root, candidateDraft) };",

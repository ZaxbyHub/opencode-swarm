...
export const RETENTION_REGISTRY: readonly RetentionRow[] = [
	...
	},
	{
		...
		readerCitations: [
			...
			'src/services/session-reflection.ts:370 gatherLedgerRejections — TAIL-BOUNDED 16 MiB (MAX_LEDGER_BYTES :354, applied :386)',
		],
	...
	},
	{
		...
		readerCitations: [
			...
			'src/services/session-reflection.ts:521 gatherSkillViolations — via tail reader',
		],

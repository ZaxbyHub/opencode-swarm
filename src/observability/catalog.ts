 ...
 *
 * Exactly 62 entries, matching the `TelemetryEvent` union at
...
export interface CatalogEntry {
	 ...
	 *
	 * `false` for all 62 entries today, and that is a truthful statement about
...
const CONSUMER_HEARTBEAT_LISTENER = Object.freeze(['src/telemetry.ts:366']);
...
const CATALOG_SOURCE: readonly (readonly [string, CatalogEntryInput])[] = [
	...
	[
		'heartbeat',
		{
			...
			severity: 'debug',
			privacyClass: 'pseudonymous',
			producer: 'src/telemetry.ts:1059',
	...
	[
		'turbo_mode_changed',
		{
			...
			severity: 'info',
			privacyClass: 'pseudonymous',
			producer: 'src/telemetry.ts:1067',
			consumers: NO_CONSUMERS,
			futureOwnerIssue: ISSUE_SINK,
			retentionOwnerIssue: ISSUE_LIFECYCLE_RETENTION,
			requiredWorkflowIds: REQUIRE_SESSION,
	...
	[
		'environment_detected',
		{
			...
			severity: 'info',
			privacyClass: 'pseudonymous',
			producer: 'src/telemetry.ts:1092',
			consumers: NO_CONSUMERS,
			futureOwnerIssue: ISSUE_SINK,
			retentionOwnerIssue: ISSUE_LIFECYCLE_RETENTION,
			requiredWorkflowIds: REQUIRE_SESSION,
	...
	[
		'retrieval_routed',
		{
			...
			severity: 'info',
			privacyClass: 'pseudonymous',
			producer: 'src/telemetry.ts:1469',
			consumers: NO_CONSUMERS,
			futureOwnerIssue: ISSUE_SINK,
			retentionOwnerIssue: ISSUE_SINK,
			requiredWorkflowIds: REQUIRE_SESSION,
	...
	[
		'scope_violation',
		{
			...
			privacyClass: 'sensitive',
			producer: 'src/telemetry.ts:1047',
			consumers: NO_CONSUMERS,
			futureOwnerIssue: ISSUE_SINK,
			retentionOwnerIssue: ISSUE_SINK,
			requiredWorkflowIds: REQUIRE_SESSION,
	...
	[
		'qa_skip_violation',
		{
			...
			severity: 'warning',
			privacyClass: 'pseudonymous',
			producer: 'src/telemetry.ts:1055',
			consumers: NO_CONSUMERS,
			futureOwnerIssue: ISSUE_SINK,
			retentionOwnerIssue: ISSUE_SINK,
			requiredWorkflowIds: REQUIRE_SESSION,
	...
	[
		'auto_oversight_escalation',
		{
			...
			severity: 'warning',
			privacyClass: 'pseudonymous',
			producer: 'src/telemetry.ts:1077',
			consumers: NO_CONSUMERS,
			futureOwnerIssue: ISSUE_SINK,
			retentionOwnerIssue: ISSUE_SINK,
	...
	[
		'execution_stall_denied',
		{
			...
			privacyClass: 'pseudonymous',
			producer: 'src/telemetry.ts:1017',
			consumers: NO_CONSUMERS,
			futureOwnerIssue: ISSUE_SINK,
			retentionOwnerIssue: ISSUE_SINK,
			requiredWorkflowIds: REQUIRE_SESSION,
	...
	[
		'swarm_internals_read_denied',
		{
			...
			privacyClass: 'sensitive',
			producer: 'src/telemetry.ts:1034',
			consumers: NO_CONSUMERS,
			futureOwnerIssue: ISSUE_SINK,
			retentionOwnerIssue: ISSUE_SINK,
			requiredWorkflowIds: REQUIRE_SESSION,
	...
	[
		'prm_hard_stop_delivered',
		{
			...
			privacyClass: 'pseudonymous',
			producer: 'src/telemetry.ts:1450',
			consumers: NO_CONSUMERS,
			futureOwnerIssue: ISSUE_SINK,
			retentionOwnerIssue: ISSUE_SINK,
			requiredWorkflowIds: REQUIRE_SESSION,
	...
	[
		'prm_course_correction_injected',
		{
			...
			severity: 'notice',
			privacyClass: 'pseudonymous',
			producer: 'src/telemetry.ts:1121',
			consumers: NO_CONSUMERS,
			futureOwnerIssue: ISSUE_SINK,
			retentionOwnerIssue: ISSUE_SINK,
			requiredWorkflowIds: REQUIRE_SESSION,
	...
	[
		'prm_hard_stop',
		{
			...
			severity: 'critical',
			privacyClass: 'pseudonymous',
			producer: 'src/telemetry.ts:1148',
			consumers: NO_CONSUMERS,
			futureOwnerIssue: ISSUE_SINK,
			retentionOwnerIssue: ISSUE_SINK,
			requiredWorkflowIds: REQUIRE_SESSION,
	...
	[
		'close_archive_result',
		{
			...
			severity: 'notice',
			privacyClass: 'operational',
			producer: 'src/telemetry.ts:1185',
			consumers: NO_CONSUMERS,
			futureOwnerIssue: ISSUE_SINK,
			retentionOwnerIssue: ISSUE_SINK,
		},
	...
	[
		'residue_health',
		{
			...
			severity: 'notice',
			privacyClass: 'operational',
			producer: 'src/telemetry.ts:1207',
			consumers: NO_CONSUMERS,
			futureOwnerIssue: ISSUE_SINK,
			retentionOwnerIssue: ISSUE_SINK,
	...
	[
		'context_telemetry_health',
		{
			...
			severity: 'notice',
			privacyClass: 'operational',
			producer: 'src/telemetry.ts:1251',
			consumers: NO_CONSUMERS,
			futureOwnerIssue: ISSUE_SINK,
			retentionOwnerIssue: ISSUE_SINK,
			// Aggregate-only counts; no workflow correlation applies.
	...
	[
		'core_events_health',
		{
			...
			severity: 'notice',
			privacyClass: 'operational',
			producer: 'src/telemetry.ts:1314',
			consumers: NO_CONSUMERS,
			futureOwnerIssue: ISSUE_SINK,
			retentionOwnerIssue: ISSUE_SINK,
			// Aggregate-only counts; no workflow correlation applies.
	...
	[
		'shell_audit_health',
		{
			...
			severity: 'notice',
			privacyClass: 'operational',
			producer: 'src/telemetry.ts:1338',
			consumers: NO_CONSUMERS,
			futureOwnerIssue: ISSUE_SINK,
			retentionOwnerIssue: ISSUE_SINK,
			// Aggregate-only counts; no workflow correlation applies.
	...
	[
		'pr_subscription_health',
		{
			...
			severity: 'notice',
			privacyClass: 'operational',
			producer: 'src/telemetry.ts:1390',
			consumers: NO_CONSUMERS,
			futureOwnerIssue: ISSUE_SINK,
			retentionOwnerIssue: ISSUE_SINK,
			// Aggregate-only counts; no workflow correlation applies.
	...
	[
		'learning_health_alarm',
		{
			...
			severity: 'warning',
			privacyClass: 'operational',
			producer: 'src/telemetry.ts:1434',
			consumers: NO_CONSUMERS,
			futureOwnerIssue: ISSUE_SINK,

...
export const RETENTION_REGISTRY: readonly RetentionRow[] = [
	...
	},
	{
		...
		stateClass: 'governed-content',
		privacyClass: 'metadata',
		writeLimits: { bound: 'first-run example artifact + operator-edited config', scope: 'global', citation: 'src/config/project-init.ts:10-36' },
		...
		healthSignal: 'n/a',
		owner: 'this-gate',
		disposition: { kind: 'not-a-defect', proof: 'First-run example artifact and operator-owned config files outside swarm runtime state (project-init.ts:10-36).' },
	},
	{
		id: 'bundled-skills',
		category: 8,

...
const USAGE = [
	...
	'workflow without publication, the agent tool supports kind "cancel-publication" with',
	'cancel_publication: true and a reason — the publication generation is recorded as',
	'cancelled_without_publication (terminal; never grants push authority) before the gate',
	'clears. A plain (recovery or force) abort never clears an armed window.',
	'',

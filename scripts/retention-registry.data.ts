...
export const RETENTION_REGISTRY: readonly RetentionRow[] = [
	...
	},
	{
		...
		readerCitations: [
			...
			'src/services/session-reflection.ts:520 gatherSkillViolations — via tail reader',
		],
	...
	// ─────────────────────────────────────────────────────────────────────────
	{
		...
		closePolicy: 'archived-only — ARCHIVE_ARTIFACTS (close.ts:420-422); deliberately NOT cleaned (cross-session store; compaction is the bounded-retention mechanism, close.ts:415-423 docblock)',

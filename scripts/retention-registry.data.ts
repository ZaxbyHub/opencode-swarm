...
export const RETENTION_REGISTRY: readonly RetentionRow[] = [
	...
	// ─────────────────────────────────────────────────────────────────────────
	{
		...
		readBound: { pattern: 'full-file', bound: 'authoritative-lifecycle rationale: the ledger IS the plan authority (invariant 5); replay is the correctness path, close archives + removes terminal state', sync: true, citation: 'src/plan/ledger.ts:1756-1917; src/commands/close/clean-stage.ts:324-356' },
		...
		closePolicy: 'archived + terminal-state REMOVED unconditionally so a closed plan cannot resurrect (src/commands/close/clean-stage.ts:324-356); ledger siblings removed (src/commands/close/clean-stage.ts:221-241)',
		closeArrayMembership: {

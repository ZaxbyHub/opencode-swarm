...
| `mcp-write-receipts` | .swarm/mcp-write-receipts.jsonl | authoritative | MAX_RECEIPT_RECORDS 500 / 512 KiB journal / 16 KiB line cap (global) | line-bounded: ≤512 KiB and 500 records | untouched (MCP audit history retained; capacity fails closed) | not a defect — #2500; direct-file exemption (#2500) |

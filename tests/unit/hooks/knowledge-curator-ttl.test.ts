...
const curatorBeforeEach = createCuratorBeforeEach(mocks, mockTransactKnowledge);

// ============================================================================
// Date.now() mocking setup (TTL-specific)
// ============================================================================

let mockNow = 1000000000000; // Fixed base time

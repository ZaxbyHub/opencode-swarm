...
export const RETENTION_REGISTRY: readonly RetentionRow[] = [
	...
	},
	{
		...
		writerCitations: [
			...
			'src/hooks/skill-usage-log.ts:1576 pruneSkillUsageLog — atomic temp+rename rewrite :1717-1723, applies applyRetention (:1022) and the marker-drop rewrite',
		...
		readerCitations: [
			...
			"src/hooks/skill-usage-log.ts:302 parseFeedbackMarker — parses feedback_applied markers during the migration's streaming acknowledgment pass (migrateLegacyLog pass 2, :1372-1391); legacy pre-migration reader only, sync",

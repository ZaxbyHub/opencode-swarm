...
export const RETENTION_REGISTRY: readonly RetentionRow[] = [
	...
	},
	{
		...
		writerCitations: [
			...
			'src/hooks/skill-usage-log.ts:1561 pruneSkillUsageLog — atomic temp+rename rewrite :1697-1703, applies applyRetention (:1014) and the marker-drop rewrite',
		...
		readerCitations: [
			...
			'src/hooks/skill-usage-log.ts:2075 applySkillUsageFeedback — reads the AUTHORITATIVE sidecar queue only (never the JSONL), async',
	...
	},
	{
		...
		readerCitations: [
			...
			'src/hooks/skill-usage-log.ts:2075 applySkillUsageFeedback — sole consumer of the records array (via claimFeedbackRecords :1864-1901), computes compliant/violated deltas from queue records only, never from JSONL entries',
		],

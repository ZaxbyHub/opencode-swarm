...
This list is enforced at `src/parallel/tier3-classifier.ts` (the TIER_3 basename, exact-name, keyword-prefix, and directory-segment tables). You cannot turn it off.
